...
tyInfo vinosVendidos[12] = {
    {'B', "Vino Blanca", 11.1, 1}, {'B', "Vino Blanca", 12.2, 1}, {'B', "Vino Blanca", 13.3, 1},
    {'T', "Vino Tinto", 21.1, 2}, {'T', "Vino Tinto", 22.2, 2}, {'T', "Vino Tinto", 23.3, 2},
    {'R', "Vino Rosado", 31.1, 3}, {'R', "Vino Rosado", 32.2, 3}, {'R', "Vino Rosado", 33.2, 3},
    {'M', "Vino Malvec", 55.1, 8}, {'C', "Vino Cavernet", 66.6, 8},
    {'x', "fin", 88.8, 0},
};
...
void procesarVenta(tyInfo infoVenta, int cantTipoBino[], int &maxCantVino, char &maxTipoVino){
    ...
    {
    case 'B': cantTipoBino[0] += infoVenta.cantidad;
        break;
    
    case 'T': cantTipoBino[1] += infoVenta.cantidad;
        break;
    
    case 'R': cantTipoBino[2] += infoVenta.cantidad;
        break;
    
    default: cout << "Categoria no registrada. Descripcion: " << infoVenta.descripcion << "\n";
        break;
    }

    if ((infoVenta.tipoVino == 'B' || infoVenta.tipoVino == 'T' || infoVenta.tipoVino == 'R')
        && infoVenta.cantidad > maxCantVino)
    {
...
int main(){
    ...
    while (strcmp("fin",ventaActual.descripcion))
    {
